...
import View from '@components/common/View/View/index';

test('should render correctly', () => {
  const { toJSON, getByTestId } = render(<View />);
...
test('should have working props', () => {
  const { getByTestId } = render(
    <View className="flex-1 flex-row self-center justify-between items-center rounded border mx-1 my-1 p-1 border-sky-700 bg-sky-500" />,
  );
