...
import SafeAreaView from '@components/common/View/SafeAreaView/index';

test('should render correctly', () => {
  const { toJSON, getByTestId } = render(<SafeAreaView />);
...
test('should have working props', () => {
  ...
  expect(getByTestId('SafeAreaView')).toHaveStyle({
    flexGrow: 1,
    flexShrink: 1,
    flexDirection: 'row',
    alignSelf: 'center',
  ...
  expect(getByTestId('SafeAreaView')).toHaveProp('edges', ['bottom']);
});
